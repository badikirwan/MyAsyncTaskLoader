...
public class WeatherAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.textViewNamaKota = (TextView) convertView.findViewById(R.id.txt_kota);
            holder.textViewTemperature = (TextView) convertView.findViewById(R.id.txt_temp);
            holder.textViewDescrition = (TextView) convertView.findViewById(R.id.txt_deskripsi);
        ...
        holder.textViewTemperature.setText(mData.get(position).getTemprature());
        holder.textViewDescrition.setText(mData.get(position).getDescription());
        return convertView;
    }
